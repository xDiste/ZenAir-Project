...
if(isset($_SESSION['id'])){ header('Location: ./errorPages/permissionDenied.php'); exit();};   
...
<html lang="it">
    ...
    <body>
        ...
        <form class="form-style" action="./scripts/php/login.php" method="POST" >
            <?php
                if (isset($_GET['error'])){
            ...
            <div class="form-group">
                ...
                <input name="pass" type="password" class="form-control" minlength="8" id="pass" required>
            </div>

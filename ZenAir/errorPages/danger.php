    ...
    <body>
        ...
        <div class="card text-white bg-warning mb-3" style="width: 100%!important;border-radius:0!important; margin:0!important;">
            <div class="card-body">
                ...
                <p class="card-text"> Stai cercando di inserire due stessi biglietti , in caso di errore dell'ordine
                andare sulla sezione <a href="<?php echo $GLOBALS['baseUrl'];?>/carrello.php">Carrello</a> ed eliminarli altrimenti contatta l'assistenza,
                per favore torna alla <a href="<?php echo $GLOBALS['baseUrl'];?>/index.php">home</a>
                </p>
            </div>
        </div>
